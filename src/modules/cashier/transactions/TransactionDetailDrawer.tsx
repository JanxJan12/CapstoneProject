...
export function TransactionDetailDrawer({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <CashierDialogContent className="cashier-drawer left-auto right-0 top-0 h-dvh max-h-dvh w-full max-w-2xl translate-x-0 translate-y-0 overflow-y-auto rounded-none bg-[#f8f4ef] p-0 shadow-[-18px_0_50px_rgba(36,26,19,0.16)] sm:max-w-2xl">
