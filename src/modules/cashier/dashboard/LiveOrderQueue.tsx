      ...
      <div className="flex items-center justify-between border-b border-border/80 bg-gradient-to-r from-amber-50/50 to-transparent p-4 sm:px-5">
        <div>
          ...
          <p className="text-[11px] font-semibold text-muted-foreground">
            Payment, kitchen, rider, and handoff readiness in one queue
          </p>
        </div>
          ...
          {orders.map((order) => {
            ...
            return (
              <button
                ...
                className={`group grid min-h-[126px] w-full grid-cols-[auto_minmax(0,1fr)_auto] gap-3 px-4 py-3 text-left transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary sm:px-5 ${delayed ? "border-l-4 border-l-red-500 bg-red-50/60 hover:bg-red-50" : "hover:bg-amber-50/35"}`}
              >
                <span
                ...
                <span className="flex min-w-[94px] items-start gap-2 text-right">
